...
repository_config = {
    'Volume':{
        'alpha':'/net/multivac/pool/alpha',
        'beta':'/net/multivac/pool/beta',
        'gama':'/net/multivac/pool/gama',
        'delta':'/net/multivac/pool/delta',
        'eta':'/net/multivac/pool/eta',
        'epsilon':'/net/multivac/pool/epsilon',
    },
    'Command':{
        'rsync':{
            'base':[u'rsync']
